const PastPatchesGuide = () => (
  <section className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 mb-6" aria-labelledby="past-patches-heading">
    ...
    <p className="mt-2 text-sm text-amber-950">Choose Cold calling, SMS, or Salesforce. Each has its own month, uploads, processing, and downloads. You can process a calling report by itself.</p>
